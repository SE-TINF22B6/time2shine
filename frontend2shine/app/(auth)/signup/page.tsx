      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h1 className="h1">Level up your game right now.</h1>
          </div>
            ...
            <form>
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
                  ...
                  <input id="full-name" type="text" className="form-input w-full text-gray-300" placeholder="Marcell D'Avis" required />
                </div>
              </div>
              <div className="flex flex-wrap -mx-3 mb-4">
                <div className="w-full px-3">
              ...
              <div className="text-sm text-gray-500 text-center">
                I hereby agree to send my soul and all of my data to time2shine.
              </div>
